    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/editar", exchange -> {
            ...
            try {
                ...
                html.append("Nome:<input name='pais' value='").append(pais).append("' required>");
        ...
        server.createContext("/animais", exchange -> {
            ...
            html.append("""
                        ...
                        <a href='/animalnovo'>+ Novo Animal</a><br><br>
        ...
        // FORM NOVO ANIMAL
        server.createContext("/animalnovo", exchange -> {
        ...
        server.createContext("/guardaranimal", exchange -> {
            ...
            try {
                ...
                html.append("""
                            ...
                            <a href='/animalnovo'>Inserir novo animal</a>
        ...
        server.createContext("/editaranimal", exchange -> {
            ...
            try {
                ...
                html.append("Email:<input name='dataNascimento' value='").append(dataNascimento).append("' required>");
